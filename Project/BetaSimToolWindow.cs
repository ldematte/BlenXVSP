...
namespace Dema.BlenX.VisualStudio.Project
{
    ...
    /// </summary>
    [Guid("9aacbb51-b4f8-49e8-8f2e-0fabc307fb0f")]
    public class BetaSimToolWindow : ToolWindowPane
    {
        ...
        private BetaSimControl control;
        ...
        internal void Update(List<BetaSimResult> list)
        {
            control.UpdateList(list);
        }
    }
}
