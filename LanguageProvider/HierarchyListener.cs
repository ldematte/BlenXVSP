...
namespace Dema.BlenX.VisualStudio
{
    ...
    internal class HierarchyListener : IVsHierarchyEvents, IDisposable {
        ...
        public int OnItemAdded(uint itemidParent, uint itemidSiblingPrev, uint itemidAdded) {
            ...
            Debug.WriteLine("\n\tOnItemAdded\n");
            string name;
            if (!IsBlenXFile(itemidAdded, out name)) {
                return VSConstants.S_OK;
            }
        ...
        public int OnItemDeleted(uint itemid) {
            ...
            string name;
            if (!IsBlenXFile(itemid, out name)) {
                return VSConstants.S_OK;
            }
        ...
        private bool IsBlenXFile(uint itemId, out string canonicalName) {
            ...
            return
                (String.Equals(extension, BlenXPackageConstants.bfuncFileExtension, StringComparison.OrdinalIgnoreCase) ||
                 String.Equals(extension, BlenXPackageConstants.btypeFileExtension, StringComparison.OrdinalIgnoreCase) ||
                 String.Equals(extension, BlenXPackageConstants.bfuncFileExtension, StringComparison.OrdinalIgnoreCase));
        }
        ...
        private void InternalScanHierarchy(uint itemId) {
            ...
            while (VSConstants.VSITEMID_NIL != currentItem) {
                ...
                string itemName;
                if ((null != onItemAdded) && IsBlenXFile(currentItem, out itemName)) {
