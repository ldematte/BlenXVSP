...
namespace Babel
{
    ...
    public sealed class RegisterSnippetsAttribute : RegistrationAttribute {
        ...
        public RegisterSnippetsAttribute (string languageGuid, bool showRoots, string displayName, 
        ...
        public override void Register(RegistrationContext context)  {
            ...
            using (Key childKey = context.CreateKey(LanguageName())) {
                ...
                childKey.SetValue("DisplayName", DisplayName);
                ...
                string myDocumentsPath = @";%MyDocs%\Code Snippets\" + DisplayName + @"\My Code Snippets\";
